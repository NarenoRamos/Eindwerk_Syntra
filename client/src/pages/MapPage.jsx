...
const MapPage = (args) => {
    const initialZoom = window.innerWidth <= 768 ? 12.4 : 13;
    const position = window.innerWidth <= 768 ? [51.18, 4.4050] : [51.2223, 4.3960];
            ...
            <Collapse isOpen={isOpen} {...args}>
                ...
                <CardBody>
                    ...
                    <Input id="exampleSelect" name="select" type="select" value={vehicleClass} onChange={(e) => setvehicleClass(e.target.value)}>
                        <option value={2}>2 - Passenger cars</option>
                        <option value={3}>3 - Delivery vans</option>
                        <option value={4}>4 - Rigid trucks</option>
                        <option value={5}>5 - Articulated trucks or buses</option>
                    </Input>
                    </FormGroup>
                    <FormGroup>
