...
Vul de .env file aan naar gewenste configuratie. 
...
De link van de Jupyter server is terug te vinden door de logs te openen van de Jupyter container:
 ...
 ```
Open de link in de browser en voer de 3 notebooks uit om de initiële tabellen in de PostgreSQL-database aan te maken. Eens deze succesvol zijn uitgevoerd, is de setup klaar. De react-dev container en jupyter-server container hoeven niet te draaien in production en mogen gestopt worden. 
 ```bash
